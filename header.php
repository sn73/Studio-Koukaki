    ...
    <div id="page" class="site">
        ...
        <header id="masthead" class="site-header">
            <nav id="site-navigation" class="main-navigation">
                ...
                <ul>
                    <img class="logo" src="<?php echo get_theme_file_uri('/assets/images/logo_koukaki.png'); ?>">
                    <li class="flower-burger"><a href="#story">Histoire</a></li>
                    <li class="perso"><a href="#characters">Personnages</a></li>
                    <li class="site-title"><a href="<?php echo esc_url(home_url('/')); ?>" rel="home"><?php bloginfo('name'); ?></a></li>
                    <li class="lieu" ><a href="#place">Lieu</a></li>
                    <li class="stud" ><a href="#studio">Studio Koukaki</a></li>
                    <span class="name-site">STUDIO KOUKAKI</span>
                </ul>
